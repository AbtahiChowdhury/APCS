/**
 * Compute the length of the hypotenuse of a right triangle given the lengths of the sides.
 * 
...
public class RightTriangle
{
    ...
    {
        double side1, side2, s1, s2; // lengths of the sides of a right triangle
